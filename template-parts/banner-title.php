  ...
  <div class="container">
    <div class="row flex-vertical-center">
      <div class="col-sm-6">
        ...
        <p><?php echo wp_kses_post( get_theme_mod( 'subscribe_text', '<p><strong>Want to save 25% on the course?</strong> Enter your email and we\'ll send you the discount code!</p>' ) ); ?></p>
